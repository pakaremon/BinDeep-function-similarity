...
files = []
with open("D:\\HocTap\\HK2_2023_2024\\ML\\Project\\file32bit_curl.csv", "r") as csv_file:
    reader = csv.reader(csv_file)
    for row in reader:
        files.append(row[0].strip())
'''
D:\IDA\IDAPro6.6>idaq.exe -a- -B 
...
IDA_PATH = "D:\\IDA\\IDAPro6.6\\idaq.exe"
...
for f in files:
    ...
    output_path = "D:\\HocTap\\HK2_2023_2024\\ML\\Project\\Dataset\\IDBs\\curl_32\\" + str(f) + ".idb"
